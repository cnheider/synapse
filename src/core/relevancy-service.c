...
gfloat synapse_relevancy_backend_get_application_popularity (SynapseRelevancyBackend* self, const gchar* desktop_id) {
#line 25 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
gfloat synapse_relevancy_backend_get_uri_popularity (SynapseRelevancyBackend* self, const gchar* uri) {
#line 26 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	g_return_val_if_fail (self != NULL, 0.0F);
#line 26 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
void synapse_relevancy_backend_application_launched (SynapseRelevancyBackend* self, GAppInfo* app_info) {
#line 28 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
#line 23 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
#line 37 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
#line 40 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
#line 58 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	g_return_if_fail (self != NULL);
#line 61 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
gfloat synapse_relevancy_service_get_application_popularity (SynapseRelevancyService* self, const gchar* desktop_id) {
	...
	gfloat _tmp3_ = 0.0F;
#line 65 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	g_return_val_if_fail (self != NULL, 0.0F);
#line 65 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	g_return_val_if_fail (desktop_id != NULL, 0.0F);
#line 67 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
#line 68 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
gfloat synapse_relevancy_service_get_uri_popularity (SynapseRelevancyService* self, const gchar* uri) {
	...
	const gchar* _tmp2_ = NULL;
	gfloat _tmp3_ = 0.0F;
#line 71 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	g_return_val_if_fail (self != NULL, 0.0F);
#line 71 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	g_return_val_if_fail (uri != NULL, 0.0F);
#line 73 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	_tmp0_ = self->priv->backend;
#line 73 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	if (_tmp0_ == NULL) {
#line 73 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
#line 74 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	_tmp1_ = self->priv->backend;
#line 74 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	_tmp2_ = uri;
#line 74 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
#line 77 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	g_return_if_fail (self != NULL);
#line 77 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	g_return_if_fail (app_info != NULL);
#line 79 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	g_debug ("relevancy-service.vala:79: application launched");
#line 80 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	_tmp0_ = self->priv->backend;
#line 80 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	if (_tmp0_ == NULL) {
#line 80 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
#line 81 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	_tmp1_ = self->priv->backend;
#line 81 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	_tmp2_ = app_info;
#line 81 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
gint synapse_relevancy_service_compute_relevancy (gint base_relevancy, gfloat modifier) {
	...
	gint _tmp0_ = 0;
	gfloat _tmp1_ = 0.0F;
#line 88 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	_tmp0_ = base_relevancy;
#line 88 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	_tmp1_ = modifier;
#line 88 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	relevancy = (gint) (_tmp0_ + ((_tmp1_ * SYNAPSE_MATCH_SCORE_INCREMENT_LARGE) * 2));
#line 90 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	result = relevancy;
#line 90 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	return result;
...
#line 48 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
#line 50 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	synapse_relevancy_service_instance = self;
#line 51 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	g_object_add_weak_pointer ((GObject*) self, &synapse_relevancy_service_instance);
#line 53 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
#line 31 "/home/heider/github/synapse/src/core/relevancy-service.vala"
...
#line 31 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, SYNAPSE_TYPE_RELEVANCY_SERVICE, SynapseRelevancyService);
#line 56 "/home/heider/github/synapse/src/core/relevancy-service.vala"
	_g_object_unref0 (self->priv->backend);
#line 31 "/home/heider/github/synapse/src/core/relevancy-service.vala"
