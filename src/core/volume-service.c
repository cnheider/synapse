/* volume-service.c generated by valac 0.30.0, the Vala compiler
...
#line 29 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 32 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 56 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_return_if_fail (volume != NULL);
#line 57 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
static void __lambda11_ (SynapseVolumeService* self, GVolume* volume) {
	GeeMap* _tmp0_ = NULL;
	GVolume* _tmp1_ = NULL;
#line 59 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_return_if_fail (volume != NULL);
#line 60 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp0_ = self->priv->volumes;
#line 60 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp1_ = volume;
#line 60 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 62 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_return_if_fail (mount != NULL);
#line 63 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp0_ = mount;
#line 63 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp1_ = g_mount_get_volume (_tmp0_);
#line 63 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	volume = _tmp1_;
#line 64 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp2_ = volume;
#line 64 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	if (_tmp2_ == NULL) {
#line 64 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 66 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
static void _g_object_unref0_ (gpointer var) {
#line 52 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 54 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 70 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp4_ = self->priv->vm;
#line 70 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp5_ = g_volume_monitor_get_volumes (_tmp4_);
#line 70 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	volume_list = _tmp5_;
#line 71 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
static void synapse_volume_service_process_volume_list (SynapseVolumeService* self, GList* volume_list) {
	GList* _tmp0_ = NULL;
#line 74 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_return_if_fail (self != NULL);
#line 76 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp0_ = volume_list;
...
#line 78 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 82 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 84 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp0_ = self->priv->volumes;
#line 84 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
gchar* synapse_volume_service_uri_to_volume_name (SynapseVolumeService* self, const gchar* uri, gchar** volume_path) {
	...
	GFile* _tmp4_ = NULL;
#line 87 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 87 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_return_val_if_fail (uri != NULL, NULL);
#line 89 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_g_free0 (_vala_volume_path);
#line 89 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_vala_volume_path = NULL;
#line 90 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp0_ = self->priv->volumes;
#line 90 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 90 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_volumes = _tmp2_;
#line 92 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp3_ = uri;
#line 92 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 94 "/home/heider/github/synapse-project/src/core/volume-service.vala"
		_tmp5_ = g_volumes;
#line 94 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 96 "/home/heider/github/synapse-project/src/core/volume-service.vala"
			_tmp11_ = volume;
#line 96 "/home/heider/github/synapse-project/src/core/volume-service.vala"
			_tmp12_ = g_volume_get_activation_root (_tmp11_);
#line 96 "/home/heider/github/synapse-project/src/core/volume-service.vala"
			root = _tmp12_;
#line 97 "/home/heider/github/synapse-project/src/core/volume-service.vala"
			_tmp13_ = root;
#line 97 "/home/heider/github/synapse-project/src/core/volume-service.vala"
			if (_tmp13_ == NULL) {
#line 615 "volume-service.c"
				...
				GMount* _tmp17_ = NULL;
				GFile* _tmp18_ = NULL;
#line 99 "/home/heider/github/synapse-project/src/core/volume-service.vala"
				_tmp14_ = volume;
#line 99 "/home/heider/github/synapse-project/src/core/volume-service.vala"
				_tmp15_ = g_volume_get_mount (_tmp14_);
#line 99 "/home/heider/github/synapse-project/src/core/volume-service.vala"
				mount = _tmp15_;
#line 100 "/home/heider/github/synapse-project/src/core/volume-service.vala"
				_tmp16_ = mount;
#line 100 "/home/heider/github/synapse-project/src/core/volume-service.vala"
				if (_tmp16_ == NULL) {
#line 100 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 101 "/home/heider/github/synapse-project/src/core/volume-service.vala"
				_tmp17_ = mount;
#line 101 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 104 "/home/heider/github/synapse-project/src/core/volume-service.vala"
			_tmp19_ = f;
#line 104 "/home/heider/github/synapse-project/src/core/volume-service.vala"
			_tmp20_ = root;
#line 104 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 662 "volume-service.c"
				...
				gchar* _tmp25_ = NULL;
#line 106 "/home/heider/github/synapse-project/src/core/volume-service.vala"
				_tmp22_ = root;
#line 106 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 107 "/home/heider/github/synapse-project/src/core/volume-service.vala"
				_tmp24_ = volume;
#line 107 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 111 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	result = NULL;
#line 111 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_g_object_unref0 (f);
#line 111 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 44 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 46 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	synapse_volume_service_instance = self;
#line 48 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 49 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
void synapse_volume_service_volume_object_update_state (SynapseVolumeServiceVolumeObject* self) {
	GVolume* _tmp0_ = NULL;
#line 154 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_return_if_fail (self != NULL);
#line 156 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 159 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 161 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp0_ = self->priv->_volume;
#line 161 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
SynapseVolumeServiceVolumeObject* synapse_volume_service_volume_object_construct (GType object_type, GVolume* volume) {
	...
	GVolume* _tmp0_ = NULL;
#line 164 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_return_val_if_fail (volume != NULL, NULL);
#line 166 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp0_ = volume;
#line 166 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
GVolume* synapse_volume_service_volume_object_get_volume (SynapseVolumeServiceVolumeObject* self) {
	GVolume* result;
	GVolume* _tmp0_ = NULL;
#line 121 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 121 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp0_ = self->priv->_volume;
#line 121 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
static void _synapse_volume_service_volume_object_update_state_g_volume_changed (GVolume* _sender, gpointer self) {
#line 147 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 122 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	g_return_if_fail (self != NULL);
#line 124 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp0_ = value;
#line 124 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 125 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp2_ = value;
#line 125 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 125 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_g_free0 (_tmp4_);
#line 126 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	synapse_match_set_description ((SynapseMatch*) self, "");
#line 127 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp5_ = value;
#line 127 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 128 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	synapse_match_set_has_thumbnail ((SynapseMatch*) self, FALSE);
#line 134 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp10_ = value;
#line 134 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 925 "volume-service.c"
		...
		gchar* _tmp19_ = NULL;
		gchar* _tmp20_ = NULL;
#line 136 "/home/heider/github/synapse-project/src/core/volume-service.vala"
		_tmp14_ = value;
#line 136 "/home/heider/github/synapse-project/src/core/volume-service.vala"
		_tmp15_ = g_volume_get_mount (_tmp14_);
#line 136 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 137 "/home/heider/github/synapse-project/src/core/volume-service.vala"
		synapse_uri_match_set_file_type ((SynapseUriMatch*) self, SYNAPSE_QUERY_FLAGS_PLACES);
#line 138 "/home/heider/github/synapse-project/src/core/volume-service.vala"
		synapse_uri_match_set_mime_type ((SynapseUriMatch*) self, "");
#line 959 "volume-service.c"
	} else {
#line 142 "/home/heider/github/synapse-project/src/core/volume-service.vala"
		synapse_uri_match_set_uri ((SynapseUriMatch*) self, NULL);
#line 963 "volume-service.c"
	}
#line 145 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 150 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp25_ = value;
#line 150 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 114 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 171 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_tmp0_ = self->priv->changed_signal_id;
#line 171 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	if (_tmp0_ != ((gulong) 0)) {
#line 175 "/home/heider/github/synapse-project/src/core/volume-service.vala"
		self->priv->changed_signal_id = (gulong) 0;
#line 1055 "volume-service.c"
	}
#line 118 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_g_object_unref0 (self->priv->_volume);
#line 114 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 23 "/home/heider/github/synapse-project/src/core/volume-service.vala"
...
#line 23 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, SYNAPSE_TYPE_VOLUME_SERVICE, SynapseVolumeService);
#line 38 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	synapse_volume_service_instance = NULL;
#line 41 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_g_object_unref0 (self->priv->vm);
#line 42 "/home/heider/github/synapse-project/src/core/volume-service.vala"
	_g_object_unref0 (self->priv->volumes);
#line 23 "/home/heider/github/synapse-project/src/core/volume-service.vala"
